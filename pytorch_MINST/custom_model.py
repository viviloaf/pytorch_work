...
#define neural network, this is defining it layer by layer
class Net(nn.Module):
	def __init__(self):
		super(Net, self).__init__()
		self.conv1 = nn.Conv2d(1, 100, kernel_size=5)
		self.conv2 = nn.Conv2d(100, 20, kernel_size=5)
		self.conv3 = nn.Conv2d(100, 20, kernel_size=5)
		self.conv4 = nn.Conv2d(100, 20, kernel_size=5)
		self.conv5 = nn.Conv2d(100, 20, kernel_size=5)
		self.conv6 = nn.Conv2d(100, 20, kernel_size=5)
		self.conv7 = nn.Conv2d(100, 20, kernel_size=5)
